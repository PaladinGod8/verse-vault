...
import WorldImageDropzone from '../../../src/renderer/components/worlds/WorldImageDropzone';
...
describe('WorldImageDropzone', () => {
  it('renders dropzone controls and helper text', () => {
    ...
    expect(screen.getByText('World Thumbnail Upload')).toBeInTheDocument();
    expect(
