...
| `characters`                    | `id`, `world_id` (FK -> worlds, `ON DELETE CASCADE`), `name`, `profile`, `author`, `image_src`, `sections` (default `'{}'`), `wiki_summary` (default `'{}'`), `created_at`, `updated_at`                                                                                                                                                                                                                                                                                                                                                                                                        | World-scoped wiki entity; full CRUD. `author` is optional freeform credit. See `docs/features/characters.md`. |
