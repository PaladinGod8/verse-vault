...
BattleMap Step 01 (2026-03-03) adds shared constants for planned battlemaps CRUD (`BATTLEMAPS_GET_ALL_BY_WORLD`, `BATTLEMAPS_GET_BY_ID`, `BATTLEMAPS_ADD`, `BATTLEMAPS_UPDATE`, `BATTLEMAPS_DELETE`) and schema bootstrap in `db.ts`; handlers and preload bridge are intentionally not wired yet in this step.
...
| `IPC.BATTLEMAPS_GET_ALL_BY_WORLD` | `db:battlemaps:getAllByWorld` | renderer -> main | `worldId: number`                                                                                                                                                                                                                                                                                                           | `TBD (handler not wired yet)`             | _(not wired in this step)_        |
| `IPC.BATTLEMAPS_GET_BY_ID`        | `db:battlemaps:getById`       | renderer -> main | `id: number`                                                                                                                                                                                                                                                                                                                | `TBD (handler not wired yet)`             | _(not wired in this step)_        |
| `IPC.BATTLEMAPS_ADD`              | `db:battlemaps:add`           | renderer -> main | `TBD (handler not wired yet)`                                                                                                                                                                                                                                                                                               | `TBD (handler not wired yet)`             | _(not wired in this step)_        |
| `IPC.BATTLEMAPS_UPDATE`           | `db:battlemaps:update`        | renderer -> main | `TBD (handler not wired yet)`                                                                                                                                                                                                                                                                                               | `TBD (handler not wired yet)`             | _(not wired in this step)_        |
| `IPC.BATTLEMAPS_DELETE`           | `db:battlemaps:delete`        | renderer -> main | `TBD (handler not wired yet)`                                                                                                                                                                                                                                                                                               | `TBD (handler not wired yet)`             | _(not wired in this step)_        |
...
- BattleMap Step 01 (2026-03-03) adds shared constants `BATTLEMAPS_GET_ALL_BY_WORLD`, `BATTLEMAPS_GET_BY_ID`, `BATTLEMAPS_ADD`, `BATTLEMAPS_UPDATE`, and `BATTLEMAPS_DELETE`; runtime handlers, preload bridge methods, and shared type signatures are intentionally deferred to later steps.
