...
StatBlock Step 03 (2026-03-06) wires 3 read handlers in main (`STATBLOCKS_GET_ALL_BY_WORLD`, `STATBLOCKS_GET_ALL_BY_CAMPAIGN`, `STATBLOCKS_GET_BY_ID`); Steps 04-05 will wire mutations and preload bridges.
