...
Current channels cover an initial local content-record scaffold (`verses`) plus worlds/levels/abilities handlers and campaign CRUD handlers in the main process. This is the foundation for the broader offline-first domain model (campaign, worldbuilding, manuscript, and session entities).
