...
| `IPC.TOKENS_MOVE_TO_WORLD`        | `db:tokens:moveToWorld`       | renderer -> main | `tokenId: number`                                                                                                                                                                                                                                                                                                           | `Token`                                                                                                          | `src/main.ts:registerIpcHandlers` |
| `IPC.TOKENS_MOVE_TO_CAMPAIGN`     | `db:tokens:moveToCampaign`    | renderer -> main | `tokenId: number, targetCampaignId: number`                                                                                                                                                                                                                                                                                 | `Token`                                                                                                          | `src/main.ts:registerIpcHandlers` |
