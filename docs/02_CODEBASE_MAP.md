...
| `src/renderer/lib/castingRangeMath.ts`                                 | Pure casting-range math (no PixiJS): `getShapePolygon` (world-space AoE polygon for circle/rectangle/cone/line shapes), `getHighlightedSquareTiles` (square tiles ≥50% covered via Sutherland-Hodgman + shoelace), `getHighlightedHexTiles` (pointy-top hex tiles ≥50% covered); exports `AoeShape`, `CastingShapeParams`, `HighlightedSquareTile`, `HighlightedHexTile`                                                                                                                                                                                                                                                                                                                                                                                                                    |
