...
| `src/renderer/pages/WorldStatisticsConfigPage.tsx`                     | World statistics configuration page (`/world/:id/statistics`): validates world route param, loads world config JSON, parses world-level statistics (resources, passive scores), renders resource CRUD table with create/edit/delete actions via `ResourceDefinitionForm` + `ConfirmDialog`, persists config updates via `window.db.worlds.update`, provides toast-first mutation feedback, and includes loading/error states                                                                                                                                                                                                                                                                                                                                                                                                                          |
