...
| `src/shared/contracts/dbApi.ts`             | DB API method registry    | Runtime inventory of window.db method names grouped by namespace      | Stable shared contract source for preload, docs, and contract guard tests | Imports relationship method registry and exports method map constants  |
...
| `/world/:id/backgrounds`                                                          | `BackgroundsPage`           | `src/renderer/pages/BackgroundsPage.tsx`           |
