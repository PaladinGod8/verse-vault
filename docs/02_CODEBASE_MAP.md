...
The following generated artifact directories are listed in `.gitignore` and are **not tracked**:

| Directory       | Generated by                    |
| --------------- | ------------------------------- |
| `dist/`         | Vite renderer build output      |
| `out/`          | Electron Forge packaged output  |
| `.vite/`        | Vite build cache (main/preload) |
...
| Path                                                                   | Responsibility                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/main.ts`                                                          | App bootstrap, BrowserWindow creation, and domain IPC registrar wiring only (`registerVerseHandlers`, `registerWorldHandlers`, `registerLevelHandlers`, `registerCampaignHandlers`, `registerBattleMapHandlers`, `registerTokenHandlers`, `registerArcHandlers`, `registerActHandlers`, `registerSessionHandlers`, `registerSceneHandlers`, `registerAbilityHandlers`, `registerStatBlockHandlers`); registers `vv-media://` protocol serving both `token-images` and `world-images` hosts for secure local image serving                                                                                                                                                                                                                                                                                                                                                                                                     |
| `src/main/ipc/validation.ts`                                           | Shared main-process IPC validation helpers (`isJsonRecord`, `parseJsonText`, `ensureFiniteNumber`, `ensurePositiveFiniteNumber`, `ensureSqliteBooleanNumber`, `isSqliteUniqueConstraintError`) reused by multiple registrars                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `src/main/ipc/registerVerseHandlers.ts`                                | Verse domain IPC registrar: registers `VERSES_GET_ALL`, `VERSES_ADD`, `VERSES_UPDATE`, and `VERSES_DELETE` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `src/main/ipc/registerWorldHandlers.ts`                                | World domain IPC registrar: registers `WORLDS_GET_ALL`, `WORLDS_GET_BY_ID`, `WORLDS_ADD`, `WORLDS_UPDATE`, `WORLDS_DELETE`, `WORLDS_MARK_VIEWED`, and `WORLDS_IMPORT_IMAGE` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `src/main/ipc/registerLevelHandlers.ts`                                | Level domain IPC registrar: registers `LEVELS_GET_ALL_BY_WORLD`, `LEVELS_GET_BY_ID`, `LEVELS_ADD`, `LEVELS_UPDATE`, and `LEVELS_DELETE` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `src/main/ipc/registerCampaignHandlers.ts`                             | Campaign domain IPC registrar: registers `CAMPAIGNS_GET_ALL_BY_WORLD`, `CAMPAIGNS_GET_BY_ID`, `CAMPAIGNS_ADD`, `CAMPAIGNS_UPDATE`, and `CAMPAIGNS_DELETE` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `src/main/ipc/registerBattleMapHandlers.ts`                            | BattleMap domain IPC registrar: registers `BATTLEMAPS_GET_ALL_BY_WORLD`, `BATTLEMAPS_GET_BY_ID`, `BATTLEMAPS_ADD`, `BATTLEMAPS_UPDATE`, and `BATTLEMAPS_DELETE` handlers, including runtime config normalization/validation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `src/main/ipc/registerTokenHandlers.ts`                                | Token domain IPC registrar: registers `TOKENS_GET_ALL_BY_WORLD`, `TOKENS_GET_ALL_BY_CAMPAIGN`, `TOKENS_GET_BY_ID`, `TOKENS_IMPORT_IMAGE`, `TOKENS_ADD`, `TOKENS_UPDATE`, `TOKENS_MOVE_TO_WORLD`, `TOKENS_MOVE_TO_CAMPAIGN`, and `TOKENS_DELETE` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `src/main/ipc/registerArcHandlers.ts`                                  | Arc domain IPC registrar: registers `ARCS_GET_ALL_BY_CAMPAIGN`, `ARCS_GET_BY_ID`, `ARCS_ADD`, `ARCS_UPDATE`, and `ARCS_DELETE` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `src/main/ipc/registerActHandlers.ts`                                  | Act domain IPC registrar: registers `ACTS_GET_ALL_BY_ARC`, `ACTS_GET_ALL_BY_CAMPAIGN`, `ACTS_GET_BY_ID`, `ACTS_ADD`, `ACTS_UPDATE`, `ACTS_DELETE`, and `ACTS_MOVE_TO_ARC` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `src/main/ipc/registerSessionHandlers.ts`                              | Session domain IPC registrar: registers `SESSIONS_GET_ALL_BY_CAMPAIGN`, `SESSIONS_GET_ALL_BY_ACT`, `SESSIONS_GET_BY_ID`, `SESSIONS_ADD`, `SESSIONS_UPDATE`, `SESSIONS_DELETE`, and `SESSIONS_MOVE_TO_ACT` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `src/main/ipc/registerSceneHandlers.ts`                                | Scene domain IPC registrar: registers `SCENES_GET_ALL_BY_CAMPAIGN`, `SCENES_GET_ALL_BY_SESSION`, `SCENES_GET_BY_ID`, `SCENES_ADD`, `SCENES_UPDATE`, `SCENES_DELETE`, and `SCENES_MOVE_TO_SESSION` handlers, including scene payload validation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `src/main/ipc/registerAbilityHandlers.ts`                              | Ability domain IPC registrar: registers `ABILITIES_GET_ALL_BY_WORLD`, `ABILITIES_GET_BY_ID`, `ABILITIES_ADD`, `ABILITIES_UPDATE`, `ABILITIES_DELETE`, `ABILITIES_ADD_CHILD`, `ABILITIES_REMOVE_CHILD`, and `ABILITIES_GET_CHILDREN` handlers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `src/main/ipc/registerStatBlockHandlers.ts`                            | StatBlock domain IPC registrar: registers `STATBLOCKS_GET_ALL_BY_WORLD`, `STATBLOCKS_GET_ALL_BY_CAMPAIGN`, `STATBLOCKS_GET_BY_ID`, `STATBLOCKS_ADD`, `STATBLOCKS_UPDATE`, `STATBLOCKS_DELETE`, `STATBLOCKS_LINK_TOKEN`, `STATBLOCKS_UNLINK_TOKEN`, `STATBLOCKS_GET_LINKED_TOKENS`, `STATBLOCKS_GET_LINKED_STATBLOCK`, `STATBLOCKS_ATTACH_ABILITY`, `STATBLOCKS_DETACH_ABILITY`, and `STATBLOCKS_LIST_ABILITIES` handlers, including statblock config skills normalization/validation                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `src/renderer/pages/StatBlocksPage.tsx`                                | StatBlocks list page (`/world/:id/statblocks`): validates worldId, loads world statblocks, supports create/edit via shared `ModalShell` + delete confirm via shared `ConfirmDialog`, renders statblock cards with statistics preview, and uses toast-first mutation feedback for create/update/delete success/failure                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `src/renderer/components/arcs/ArcForm.tsx`                             | Reusable arc name form for create/edit (name required)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `src/renderer/components/acts/ActForm.tsx`                             | Reusable act name form for create/edit (name required)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `src/renderer/components/worlds/WorldSidebar.tsx`                      | World workspace sidebar: Level + Ability + Campaigns + BattleMaps + Tokens + StatBlocks + Statistics nav items linking to `/world/:id/levels`, `/world/:id/abilities`, `/world/:id/campaigns`, `/world/:id/battlemaps`, `/world/:id/tokens`, `/world/:id/statblocks`, and `/world/:id/statistics`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `src/renderer/components/statblocks/StatBlockCard.tsx`                 | StatBlock card component: displays name, description, token count, and linked statistics preview; exposes edit and delete action callbacks                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `src/renderer/components/statblocks/StatBlockForm.tsx`                 | Reusable statblock form for create/edit: name + optional description, config JSON text, resource statistic inputs, passive score inputs, and ability assignment manager                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `.eslintrc.cjs`                                                        | ESLint configuration (CJS format to support inline comments): extends `eslint:recommended`, `@typescript-eslint`, `plugin:import/*`, and `prettier`; enforces architectural import boundaries via `import/no-restricted-paths` (renderer cannot import from `src/main.ts`, `src/main/**`, or `src/database/**`; preload cannot import from `src/renderer/**`) and `no-restricted-imports` override (renderer files cannot import `electron` directly — must use `window.db`); `src/shared/**` and `forge.env.d.ts` are unrestricted; adds file-size budgets (`max-lines ≤ 400` for `src/**`, `≤ 600` for `tests/**`), function complexity budget (`complexity ≤ 15` globally), and function-length budget (`max-lines-per-function ≤ 80` for utility/lib code); existing oversized files have per-file `overrides` with `TODO` comments tracking future removal                                                               |
...
| `scripts/guard-docs.cjs`                                               | Pre-commit hook: if any `src/**` file is staged, requires `docs/02_CODEBASE_MAP.md` to also be staged; if architecture-adjacent files are staged, requires `docs/01_ARCHITECTURE.md` to also be staged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `scripts/guard-ipc-docs.cjs`                                           | Pre-commit hook: if any of `src/preload.ts`, `src/main.ts`, `src/shared/ipcChannels.ts`, or `forge.env.d.ts` are staged, requires `docs/03_IPC_CONTRACT.md` to also be staged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `scripts/lint-changed.cjs`                                             | Runs ESLint only on git-changed files for faster feedback; used in pre-push quality gate instead of full lint on every file                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `scripts/lint-tracked-markdown.cjs`                                    | Runs Vale markdown linter on git-tracked Markdown files; supports `--scope` flag to target `all`, `docs`, or `feature-docs` partition                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `scripts/rebuild-native.cjs`                                           | Rebuilds native modules (`better-sqlite3`) for the active Electron version with retry logic and lock-file handling                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `scripts/runner-services.ps1`                                          | PowerShell helper for managing the GitHub Actions self-hosted runner service on Windows: `status`/`start`/`stop`/`restart` actions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `scripts/verify-all.cjs`                                               | Full local verification pipeline: install, lint, tsc, format check, build, and test (unit + E2E); used to run the complete CI gate locally before push                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `scripts/verify-rapid.cjs`                                             | Fast verification subset: lint, tsc, and format check only — skips native rebuild, Playwright, and slow E2E; used for quick pre-push confidence checks                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `scripts/verify-smart.cjs`                                             | Git-aware local CI lane: detects the current changeset, runs targeted formatting/lint/unit checks, selects conservative E2E regression specs by touched domain, and reuses package output when the packaged-input fingerprint still matches                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `tests/unit/ipc/registrars.test.ts`                                    | Unit coverage for modular IPC registrar wiring: verifies each domain registrar registers the expected channels through `ipcMain.handle` and that combined registrar registrations exactly match all channels in `src/shared/ipcChannels.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `tests/unit/main.bootstrap.test.ts`                                    | Unit coverage for `src/main.ts` bootstrap orchestration only: verifies app lifecycle events (`ready`, `window-all-closed`), `vv-media://` protocol registration, DB initialization, and registrar delegation — asserts orchestration contracts, not domain SQL behavior                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `tests/unit/ipc/validation.test.ts`                                    | Unit coverage for shared IPC validation helpers in `src/main/ipc/validation.ts`: all branches of `isJsonRecord`, `parseJsonText`, `ensureFiniteNumber`, `ensurePositiveFiniteNumber`, `ensureSqliteBooleanNumber`, and `isSqliteUniqueConstraintError`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `tests/unit/ipc/register*Handlers.test.ts`                             | Per-domain registrar behavior tests (one file per registrar, plus a relations file for StatBlocks): each file covers read paths, input validation errors, not-found cases, sort_order auto-calc, resequencing-on-delete, and move handlers for its domain; all external I/O (Electron, `better-sqlite3`, `node:crypto`, `node:fs/promises`) is mocked so files run safely under Vitest parallel worker mode                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `tests/helpers/`                                                       | Shared test helper barrel, fixture factories, and reusable `window.db` IPC mock harness (`tests/helpers/factories.ts`, `tests/helpers/ipcMock.ts`, `tests/helpers/index.ts`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- **Main handler**: `src/main/ipc/registerLevelHandlers.ts`
...
- **Store**: none yet
- **IPC**: `IPC.LEVELS_GET_ALL_BY_WORLD`, `IPC.LEVELS_GET_BY_ID`
- **Main handler**: `src/main/ipc/registerLevelHandlers.ts` (from Step 03)
...
- **Store**: none yet
- **IPC**: `IPC.LEVELS_ADD`, `IPC.LEVELS_UPDATE`, `IPC.LEVELS_DELETE`
- **Main handler**: `src/main/ipc/registerLevelHandlers.ts` (from Step 05)
...
- **Main handler**: `src/main/ipc/registerAbilityHandlers.ts`
- **Preload bridge**: not wired in this step
...
- **Store**: none yet
- **IPC**: `IPC.ABILITIES_GET_ALL_BY_WORLD`, `IPC.ABILITIES_GET_BY_ID`, `IPC.ABILITIES_GET_CHILDREN`
- **Main handler**: `src/main/ipc/registerAbilityHandlers.ts` (from Step 03)
...
- **Main handler**: `src/main/ipc/registerAbilityHandlers.ts` (from Steps 04-05)
...
- **Store**: none yet
- **IPC**: `IPC.BATTLEMAPS_GET_ALL_BY_WORLD`, `IPC.BATTLEMAPS_GET_BY_ID`, `IPC.BATTLEMAPS_ADD`, `IPC.BATTLEMAPS_UPDATE`, `IPC.BATTLEMAPS_DELETE`
- **Main handler**: `src/main/ipc/registerBattleMapHandlers.ts`
- **Preload bridge**: not wired in this step
...
- **Store**: none yet
- **IPC**: `IPC.BATTLEMAPS_GET_ALL_BY_WORLD`, `IPC.BATTLEMAPS_GET_BY_ID`, `IPC.BATTLEMAPS_ADD`, `IPC.BATTLEMAPS_UPDATE`, `IPC.BATTLEMAPS_DELETE`
- **Main handler**: `src/main/ipc/registerBattleMapHandlers.ts` (from Step 02)
...
- **Store**: none yet
- **IPC**: `IPC.CAMPAIGNS_GET_ALL_BY_WORLD`, `IPC.CAMPAIGNS_GET_BY_ID`, `IPC.CAMPAIGNS_ADD`, `IPC.CAMPAIGNS_UPDATE`, `IPC.CAMPAIGNS_DELETE`
- **Main handler**: `src/main/ipc/registerCampaignHandlers.ts`
- **Preload bridge**: not wired in this step
...
- **Tests**: `tests/unit/ipc/registerStatBlockHandlers.test.ts` — read behavior assertions (`getAllByWorld` returns array, `getAllByCampaign` returns array, `getById` returns matching row, `getById` returns `null` for missing id); formerly covered in the deleted `tests/unit/main.test.ts` monolith
