...
| `src/renderer/App.tsx`                                         | Route definitions and app shell (`/`, `/world/:id`, `/world/:id/levels`, `/world/:id/abilities`, `/world/:id/campaigns`); sessions route `/world/:id/campaign/:campaignId/sessions` linked but not yet a page                                                                                                                          |
