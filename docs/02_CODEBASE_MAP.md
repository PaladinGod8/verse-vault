...
| `src/renderer/pages/BattleMapsPage.tsx`                        | BattleMaps list page (`/world/:id/battlemaps`): world-scoped table with create/edit/delete actions, `created_at` + `updated_at` timestamp columns, and loading/empty/error states                                                                                                                                                                                                                                                                                                                                                                                |
