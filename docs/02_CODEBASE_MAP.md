...
| `src/renderer/pages/BattleMapRuntimePage.tsx`                  | BattleMap runtime shell page (`/world/:id/battlemaps/:battleMapId/runtime`): validates world/battlemap route params, loads battlemap + validates config JSON object shape, renders runtime shell placeholder, and keeps a mandatory `Exit Runtime` button visible to return to battlemaps list context                                                                                                                                                                                                                                                                                                                                                                     |
