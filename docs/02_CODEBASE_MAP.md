...
| `tests/unit/renderer/lib/statisticsCalculations.test.ts`               | Unit coverage for D&D 5e statistics calculations: ability/save modifiers, modifier formatting, and resource validation/clamping; includes edge cases for non-finite values (NaN, Infinity, negative)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
