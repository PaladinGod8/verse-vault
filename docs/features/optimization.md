...
| `medium`  | `true`        | `abilities.test.ts`, `battlemaps.test.ts`, `world-statistics-config.test.ts`, `statblock-statistics.test.ts`, `casting-range-overlay.test.ts`, `tokenMove.test.ts`, `tokens.test.ts` | Medium-weight tests — max workers    |
| `runtime` | `false`       | `arc-act.test.ts`, `battlemap-runtime-play.test.ts`, `tokens-runtime-palette.test.ts`                                                                                                | Heavy flows — conservative workers   |
