/**
 * @role Ability IPC registrar
 * @owns Ability CRUD and relationship channel handlers
 * @seam Main-process adapter for ability IPC requests
 * @calls SQLite statements plus shared validation helpers
 */
