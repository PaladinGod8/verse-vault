...
process.stdout.write("process.versions.electron: " + (process.versions && process.versions.electron) + "\n");
process.stdout.write("typeof process.electronBinding: " + typeof process.electronBinding + "\n");
